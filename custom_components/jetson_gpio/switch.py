"""Allows to configure a switch using Jetson GPIO."""
...
def setup_platform(
    ...
    for port, name in ports.items():
        switches.append(JetsonGPIOSwitch(name, port, invert_logic))

    add_entities(switches)


class JetsonGPIOSwitch(SwitchEntity):
    """Representation of a Jetson GPIO."""
